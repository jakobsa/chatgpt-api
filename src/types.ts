...
export type CompletionParamsGeneric = {
...
export type CompletionResponseGeneric = {
  id: string
  object: string
  created: number
  model: string
...
export namespace openai {
  export type CompletionParams = CompletionParamsGeneric & {
    /**
  ...
  export type CompletionResponse = CompletionResponseGeneric & {
...
export namespace alephAlpha {
  ...
  export type CompletionResponseCompletions = {
    finish_reason?: string
    completion?: string
