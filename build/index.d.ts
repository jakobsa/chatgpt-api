...
type CompletionResponseGeneric = {
    id: string;
    object: string;
    created: number;
    model: string;
...
declare namespace openai {
    type CompletionParams = CompletionParamsGeneric & {
        /**
    ...
    type CompletionResponse = CompletionResponseGeneric & {
...
declare namespace alephAlpha {
    type CompletionParams = CompletionParamsGeneric & {
        /**
         * Include the log probabilities on the `log_probs` most likely tokens, as well the chosen tokens. For example, if `logprobs` is 5, the API will return a list of the 5 most likely tokens. The API will always return the `logprob` of the sampled token, so there may be up to `logprobs+1` elements in the response.  The maximum value for `logprobs` is 5. If you need more than this, please contact us through our [Help center](https://help.openai.com) and describe your use case.
         */
        log_probs?: number;
        /**
         * The maximum number of tokens to generate in the completion.  The token count of your prompt plus `max_tokens` cannot exceed the model\'s context length. Most models have a context length of 2048 tokens (except for the newest models, which support 4096).
    ...
    type CompletionResponse = CompletionResponseGeneric & {
        completions: CompletionResponseCompletions[];
    };
    type CompletionResponseCompletions = {
        finish_reason?: string;
        completion?: string;
...
declare class AlephAlphaAPI {
    protected _apiKey: string;
    protected _apiBaseUrl: string;
    protected _apiReverseProxyUrl: string;
    protected _debug: boolean;
    protected _completionParams: Omit<alephAlpha.CompletionParams, 'prompt'>;
    ...
    constructor(opts: {
        ...
        /** @defaultValue `false` **/
        debug?: boolean;
        completionParams?: Partial<alephAlpha.CompletionParams>;
        /** @defaultValue `4096` **/
...
export { AlephAlphaAPI, ChatGPTAPI, ChatGPTError, ChatGPTErrorType, ChatGPTUnofficialProxyAPI, ChatMessage, CompletionParamsGeneric, CompletionResponseGeneric, ContentType, ConversationJSONBody, ConversationResponseEvent, FetchFn, GetAccessTokenFn, GetMessageByIdFunction, Message, MessageActionType, MessageContent, MessageMetadata, Prompt, PromptContent, Role, SendMessageBrowserOptions, SendMessageOptions, UpsertMessageFunction, alephAlpha, openai };
